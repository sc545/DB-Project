...
class COrderModifyDlg : public CDialogEx
{
	DECLARE_DYNAMIC(COrderModifyDlg)

public:
	COrderModifyDlg(CWnd* pParent = NULL, LONG id = NULL);   // 표준 생성자입니다.
	virtual ~COrderModifyDlg();
	virtual BOOL OnInitDialog();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_DIALOG_ORDER_MODIFY };
